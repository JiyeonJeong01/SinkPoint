Shader "Unreal/MI_ArtifactFragments08"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "NormalMap", 2D ) = "white" {}
		Material_Texture2D_1( "MainTexture", 2D ) = "white" {}
		Material_Texture2D_2( "Occlusion", 2D ) = "white" {}
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat4 Local6 = ProcessMaterialVirtualColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local7 = MaterialStoreTexSample(Parameters, Local6, 0);
	MaterialFloat Local8 = (Local6.g - Local6.b);
	MaterialFloat Local9 = saturate(Local8);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	MaterialFloat4 Local11 = ProcessMaterialVirtualColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 2);
	MaterialFloat3 Local13 = (((MaterialFloat3)1.00000000) - Local11.rgb);
	MaterialFloat3 Local14 = (((MaterialFloat3)Local9) * Local13);
	MaterialFloat3 Local15 = (((MaterialFloat3)1.00000000) - Local14);
	MaterialFloat3 Local16 = PositiveClampedPow(Local15,((MaterialFloat3)20.00000000));
	...
	PixelMaterialInputs.AmbientOcclusion = Local11.rgb;
